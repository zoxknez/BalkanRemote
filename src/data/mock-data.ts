...
export const mockCompanies: Company[] = [
  ...
  },
  {
    id: '11',
    name: 'HTEC Group',
    logo: 'https://logo.clearbit.com/htecgroup.com',
    description: 'Product development and engineering company born in Belgrade, now operating across the region with global clients.',
    website: 'https://htecgroup.com',
    linkedin: 'https://linkedin.com/company/htec-group',
    size: '2000+ employees',
    industry: 'Outsourcing',
    location: 'Serbia • Bosnia and Herzegovina • North Macedonia (Hybrid Remote)',
    foundedYear: 2008,
    isHiring: true,
    openPositions: 35,
    benefits: ['Hybrid remote', 'Global projects', 'Learning budgets', 'Private health insurance'],
    techStack: ['Java', 'Kotlin', 'React', 'Python', 'AWS'],
    rating: 4.3,
    reviewCount: 410
  },
  {
    id: '12',
    name: 'Vega IT',
    logo: 'https://logo.clearbit.com/vegait.rs',
    description: 'Serbian software development company building custom digital products for clients worldwide.',
    website: 'https://vegait.rs',
    linkedin: 'https://linkedin.com/company/vegait',
    size: '800+ employees',
    industry: 'Outsourcing',
    location: 'Serbia (Novi Sad, Belgrade) • Remote',
    foundedYear: 2008,
    isHiring: true,
    openPositions: 18,
    benefits: ['Remote friendly', 'Tech conferences', 'Private health insurance', 'Profit share'],
    techStack: ['.NET', 'React', 'Angular', 'Azure', 'Node.js'],
    rating: 4.5,
    reviewCount: 220
  },
  {
    id: '13',
    name: 'Nordeus',
    logo: 'https://logo.clearbit.com/nordeus.com',
    description: 'Belgrade-based gaming studio best known for Top Eleven, partnering with global publishers.',
    website: 'https://nordeus.com',
    linkedin: 'https://linkedin.com/company/nordeus',
    size: '250+ employees',
    industry: 'Gaming',
    location: 'Serbia (Belgrade) • Hybrid',
    foundedYear: 2010,
    isHiring: true,
    openPositions: 9,
    benefits: ['Hybrid work', 'Performance bonuses', 'Wellbeing budget', 'Education stipend'],
    techStack: ['Unity', 'C#', 'AWS', 'Kubernetes'],
    rating: 4.6,
    reviewCount: 145
  },
  {
    ...
    description: 'Global technology company with delivery centers across the Balkans, building digital products for fintech, payments and mobility.',
    website: 'https://www.endava.com',
    linkedin: 'https://linkedin.com/company/endava',
    size: '12000+ employees',
    industry: 'Outsourcing',
    location: 'Serbia • Bosnia and Herzegovina • North Macedonia • Romania (Hybrid Remote)',
    foundedYear: 2000,
    isHiring: true,
    openPositions: 40,
    benefits: ['Hybrid work', 'Global mobility', 'Mentorship programs', 'Private healthcare'],
    techStack: ['Java', 'JavaScript', 'AWS', 'Azure', 'Python'],
    rating: 4.2,
    reviewCount: 860
  },
  {
    id: '15',
    name: 'Symphony.is',
    logo: 'https://logo.clearbit.com/symphony.is',
    description: 'Product development company founded in Sarajevo with distributed teams across Europe and the US.',
    website: 'https://symphony.is',
    linkedin: 'https://linkedin.com/company/symphony-is',
    size: '500+ employees',
    industry: 'Outsourcing',
    location: 'Bosnia and Herzegovina • Serbia • Remote Europe',
    foundedYear: 2007,
    isHiring: true,
    openPositions: 14,
    benefits: ['Remote friendly', 'Stock options', 'Global clients', 'Wellness allowance'],
    techStack: ['React', 'Node.js', 'Go', 'AWS', 'Python'],
    rating: 4.4,
    reviewCount: 190
  },
  {
    ...
    logo: 'https://logo.clearbit.com/sevenbridges.com',
    description: 'Belgrade-born healthtech scaleup building cloud genomics platforms for some of the largest pharma companies.',
    website: 'https://www.sevenbridges.com',
    linkedin: 'https://linkedin.com/company/seven-bridges-genomics',
    size: '400+ employees',
    industry: 'Healthcare',
    location: 'Serbia (Belgrade) • USA • Remote Europe',
    foundedYear: 2009,
    isHiring: true,
    openPositions: 11,
    benefits: ['Remote first', 'Equity plan', 'Private health insurance', 'Learning stipend'],
    techStack: ['Python', 'Go', 'React', 'AWS', 'Terraform'],
    rating: 4.3,
    reviewCount: 160
  },
  {
    id: '17',
    name: 'Tenderly',
    logo: 'https://logo.clearbit.com/tenderly.co',
    description: 'Belgrade-based Web3 developer platform offering observability and infrastructure tools for Ethereum developers.',
    website: 'https://tenderly.co',
    linkedin: 'https://linkedin.com/company/tenderly',
    size: '120+ employees',
    industry: 'Finance',
    location: 'Serbia (Belgrade) • Remote Europe',
    foundedYear: 2018,
    isHiring: true,
    openPositions: 7,
    benefits: ['Remote-first', 'Equity', 'Conference budget', 'Top-tier equipment'],
    techStack: ['Go', 'TypeScript', 'Rust', 'Kubernetes', 'AWS'],
    rating: 4.5,
    reviewCount: 98
  },
  {
    id: '18',
    name: 'Infobip',
    logo: 'https://logo.clearbit.com/infobip.com',
    description: 'Croatian cloud communications platform powering omnichannel customer engagement for enterprises worldwide.',
    website: 'https://www.infobip.com',
    linkedin: 'https://linkedin.com/company/infobip',
    size: '3500+ employees',
    industry: 'Technology',
    location: 'Croatia (Vodnjan, Zagreb) • Serbia • Remote Europe',
    foundedYear: 2006,
    isHiring: true,
    openPositions: 28,
    benefits: ['Hybrid remote', 'Employee stock', 'Education programs', 'Relocation support'],
    techStack: ['Java', 'Spring', 'Kafka', 'React', 'Kubernetes'],
    rating: 4.1,
    reviewCount: 540
  },
  {
    ...
    logo: 'https://logo.clearbit.com/quantox.com',
    description: 'Regional software development partner with hubs across Serbia, Bosnia, North Macedonia and Mexico.',
    website: 'https://quantox.com',
    linkedin: 'https://linkedin.com/company/quantox',
    size: '500+ employees',
    industry: 'Outsourcing',
    location: 'Serbia • Bosnia and Herzegovina • North Macedonia • Remote',
    foundedYear: 2012,
    isHiring: true,
    openPositions: 22,
    benefits: ['Remote work', 'Flexible hours', 'Education budget', 'Wellness program'],
    techStack: ['PHP', 'Laravel', 'React', 'Vue', 'AWS'],
    rating: 4.2,
    reviewCount: 150
  },
  {
    id: '20',
    name: 'Anari AI',
    logo: 'https://logo.clearbit.com/anari.ai',
    description: 'Belgrade-based AI hardware and platform startup creating configurable AI infrastructure for computer vision workloads.',
    website: 'https://anari.ai',
    linkedin: 'https://linkedin.com/company/anari-ai',
    size: '120+ employees',
    ...
    isHiring: true,
    openPositions: 6,
    benefits: ['Remote-first', 'Equity program', 'GPU credits', 'Conference stipend'],
    techStack: ['Python', 'CUDA', 'TensorFlow', 'Kubernetes', 'TypeScript'],
    rating: 4.4,
    reviewCount: 72
  },
  {
    id: '21',
    name: 'Logate Cybersecurity',
    logo: 'https://logo.clearbit.com/logate.com',
    description: 'Podgorica-based engineering company delivering IAM, SOC and telecom security products across SEE markets.',
    website: 'https://logate.com',
    ...
    isHiring: true,
    openPositions: 10,
    benefits: ['Hybrid remote', 'Blue-team lab', 'Private health insurance', 'Paid certifications'],
    techStack: ['Go', 'Java', 'Kubernetes', 'Elastic Stack', 'Azure'],
    rating: 4.3,
    reviewCount: 54
  }
]
