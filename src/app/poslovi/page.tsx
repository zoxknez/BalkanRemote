...
function OutLink({ href, label, sub }: { href: string; label: string; sub?: string }) {
  return (
    <Link
      href={href}
      target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-center mb-3">
              Brzi prečaci do relevantnih oglasa i mreža
            </h1>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-green-600 rounded-2xl p-8 text-white mb-8">
          <div className="text-center">
            <h2 className="text-2xl font-bold mb-4">🇷🇸🇭🇷🇧🇦🇲🇪 Balkanska IT scena u ekspanziji</h2>
            <p className="text-blue-100 mb-6">Naš region je novi hub za remote rad - evo ko sve zapošljava ovde</p>
        ...
        <div className="mb-6 flex flex-wrap gap-2">
          {quickChips.map((c) => (
            <Link key={c.href} href={c.href} target="_blank" className="group inline-flex items-center gap-1 rounded-full border border-gray-300 bg-white px-3 py-1.5 text-xs text-gray-700 hover:border-cyan-400 hover:text-cyan-700">
              {c.label}
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <OutLink href="https://linkedin.com/jobs/ncr-jobs/?currentJobId=4092876160" label="NCR Voyix – otvorene pozicije (često i remote)" sub="Velik broj oglasa, aktivno zapošljavaju" />
                  <OutLink href="https://linkedin.com/jobs/remote-jobs/?currentJobId=4089960638" label="LinkedIn: Remote poslovi (Srbija filter)" sub="~480 pozicija, menjaj filtere za HR/BA/MNE" />
                </div>
              </section>
              ...
              <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <OutLink href="https://youtube.com/watch?v=lfCfqEBwQ8M" label="Dispečer za USA tržište – primer posla" sub="Uvek ima otvorenih pozicija; uz AI brzo se snađeš" />
                </div>
              </section>
              ...
              <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <OutLink href="https://clutch.co/rs/it-services" label="Clutch – IT firme u Srbiji" sub="Direktorijum kompanija; izdvoji favorite i šalji CV" />
                  <OutLink href="https://joberty.com/IT-companies?page=1&sort=featured" label="Joberty – IT kompanije (globalno)" sub="Pretraži i filtriraj; pročitaj recenzije" />
                </div>
              </section>
              ...
              <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <OutLink href="https://weworkremotely.com/categories/remote-customer-support-jobs" label="WWR: Customer Support" sub="Specifična CS kategorija" />
                  <OutLink href="https://remotive.com/remote-jobs/customer-support" label="Remotive: Customer Support" sub="Customer success i support" />
                </div>
              </section>
              ...
              <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <OutLink href="https://www.goodairlanguage.com/teaching-english-online-2/" label="Lista kompanija za online predavanje engleskog" sub="Sve platforme na jednom mestu" />
                </div>
              </section>
              ...
              <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <OutLink href="https://about.gitlab.com/company/culture/all-remote/" label="GitLab – All Remote Handbook" sub="Top dokumentacija" />
                  ...
                  <OutLink href="https://skillcrush.com/blog/sites-finding-remote-work/" label="Skillcrush – Najbolji sajtovi za remote poslove" sub="Sajtovi po vrstama poslova" />
                </div>
              </section>
            ...
            <aside className="space-y-8">
              <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                ...
                <ul className="list-disc pl-5 text-sm space-y-2 text-gray-700">
                  ...
                  <li>Prati <Link href="/kompanije" className="text-blue-600 hover:underline">/kompanije</Link> za one koje zapošljavaju</li>
                </ul>
              </section>
              ...
              <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                ...
                <div className="grid grid-cols-1 gap-3">
                  <OutLink href="https://skillcrush.com/blog/sites-finding-remote-work/" label="Najbolji sajtovi za remote poslove" sub="Po kategorijama poslova" />
                  <OutLink href="https://www.goodairlanguage.com/teaching-english-online-2/" label="Kompanije za predavanje engleskog" sub="Traženi poslovi, fleksibilno" />
                </div>
              </section>
              ...
              <section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                ...
                <ul className="list-disc pl-5 text-sm space-y-2 text-gray-700">
                  ...
                  <li>Pogledaj <Link href="/saveti" className="text-blue-600 hover:underline">/saveti</Link> za detaljan vodič</li>
                </ul>
              </section>
