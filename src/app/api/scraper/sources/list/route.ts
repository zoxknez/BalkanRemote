...
// This endpoint mirrors /api/scraper/jobs but lives under /api/scraper/sources/*
// as a workaround for some production routing inconsistencies.
export async function GET(req: NextRequest) {
  ...
  if (hasSupabase) {
    try {
      ...
      // fall through to engine response below
    }
  }
